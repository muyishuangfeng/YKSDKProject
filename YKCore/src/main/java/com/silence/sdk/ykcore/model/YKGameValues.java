...
//                    + "follow_app_official_microblog," + "invitation_write";
    ...
    //Google登录成功
    public static final int GOOGLE_LOGIN_SUCCESS = BASE_CODE + 1;
    //Google登录失败
    public static final int GOOGLE_LOGIN_FAILED = BASE_CODE + 2;
    //Google登出
    public static final int GOOGLE_LOGIN_OUT = BASE_CODE + 3;
    //Facebook登录成功
    public static final int FACEBOOK_LOGIN_SUCCESS = BASE_CODE + 4;
    //Facebook登录失败
    public static final int FACEBOOK_LOGIN_FAILED = BASE_CODE + 5;
    //Facebook登录取消
    public static final int FACEBOOK_LOGIN_CANCEL = BASE_CODE + 6;
    //Facebook退出
    public static final int FACEBOOK_LOGIN_OUT = BASE_CODE + 7;
    //Google Play支付成功
    public static final int GOOGLE_PLAY_SUCCESS = BASE_CODE + 8;
    //Google Play补单
    public static final int GOOGLE_PLAY_SUPPLEMENTS = BASE_CODE + 9;
    //oneStore错误
    public static final int ONE_STORE_FAILED = BASE_CODE + 10;
    //oneStore成功
    public static final int ONE_STORE_SUCCESS = BASE_CODE + 11;
}
